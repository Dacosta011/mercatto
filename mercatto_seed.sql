...
-- Teams
insert into teams (name) values ('Liverpool') on conflict (name) do nothing;
insert into teams (name) values ('FC Barcelona') on conflict (name) do nothing;
insert into teams (name) values ('Real Madrid') on conflict (name) do nothing;
insert into teams (name) values ('Man Utd') on conflict (name) do nothing;
insert into teams (name) values ('Manchester City') on conflict (name) do nothing;
insert into teams (name) values ('Arsenal') on conflict (name) do nothing;
insert into teams (name) values ('Spurs') on conflict (name) do nothing;
insert into teams (name) values ('Juventus') on conflict (name) do nothing;
insert into teams (name) values ('Milano FC') on conflict (name) do nothing;
insert into teams (name) values ('Lombardia FC') on conflict (name) do nothing;
insert into teams (name) values ('SSC Napoli') on conflict (name) do nothing;
insert into teams (name) values ('FC Bayern München') on conflict (name) do nothing;
insert into teams (name) values ('Leverkusen') on conflict (name) do nothing;
insert into teams (name) values ('Borussia Dortmund') on conflict (name) do nothing;
insert into teams (name) values ('Atlético de Madrid') on conflict (name) do nothing;
